...
public class CommunityController {
	...
	public String list(Model model,
		...
		EzenPaging ezenPaging = new EzenPaging(page, 10, communityService.getCommunityCount(), 5);

		List<Community> communityList = this.communityService.getCommunityByLimit(keyword, ezenPaging.getStartNo(), ezenPaging.getPageSize());
